...
- (void)reloadAdImageWithUrl:(NSString *)urlStr
{
    ...
    if (cacheImage) {
        ...
        [downloader downloadImageWithURL:imageUrl options:SDWebImageDownloaderLowPriority progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
...
/** 自定义logo等信息 */
-(void)addCustomView{
    ADBottomCustomView *view=[[ADBottomCustomView alloc]initWithFrame:CGRectMake(0, self.bottom-83, self.frame.size.width, 83)];
